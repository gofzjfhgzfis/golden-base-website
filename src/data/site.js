...
export const products = [
  ...
  },
  {
    ...
    desc: {
      ku: 'ڕۆنی کوالێتی بەرز لە ڕۆنی بەکارنەهێنراوەوە، بۆ بزوێنەری نوێی بەنزین و دیزل. پلە سووکەکانی (0W-20، 5W-20) خێراتر دەگەن بە بەشەکانی بزوێنەر لە کاتی هەڵکردندا.',
      ar: 'زيت عالي الجودة من زيت غير مستعمل، لمحركات البنزين والديزل الحديثة. الدرجات الخفيفة (0W-20، 5W-20) تصل أسرع إلى أجزاء المحرك عند التشغيل.',
      en: 'High-quality oil from virgin base stock, for modern petrol and diesel engines. The lighter grades (0W-20, 5W-20) reach engine parts faster on start-up.',
    },
    features: {
  ...
  },
  {
    ...
    grades: ['5W-30', '10W-30', '15W-40', '20W-50', 'HD50', 'HD70'],
    desc: {
      ku: 'ڕۆنی heavy duty بۆ بزوێنەر و ئامێری قورس. پێکهاتەی پاککەرەوەی بەهێزی هەیە کە بزوێنەر پاک و کارا ڕادەگرێت.',
      ar: 'زيت heavy duty للمحركات والمعدات الثقيلة. تركيبة منظفة قوية تحافظ على نظافة المحرك وكفاءته.',
      en: 'A heavy-duty oil for engines and heavy equipment. A strong detergent formulation keeps the engine clean and efficient.',
    },
    features: {
  ...
  },
  {
    ...
    desc: {
      ku: 'ڕۆنی SAE 70 بۆ بزوێنەری قورس و کاری بەردەوام. چڕی بەرزی وا دەکات لە پلەی گەرمی زۆر بەرزیشدا چینی پاراستن بمێنێتەوە.',
      ar: 'زيت SAE 70 للمحركات الثقيلة والعمل المتواصل. لزوجته العالية تحافظ على طبقة الحماية حتى في درجات الحرارة المرتفعة جداً.',
      en: 'An SAE 70 oil for heavy engines in continuous service. Its high viscosity holds the protective film even at very high temperatures.',
    },
    features: {
  ...
  },
  {
    ...
    grades: ['5W-30', '10W-30', '15W-40', '20W-50', 'HD50', 'HD70'],
    desc: {
      ku: 'ڕۆنی fully synthetic بۆ بزوێنەری بەنزین و دیزل. جێگیری زیاتری هەیە لە گەرمیدا و پاراستنێکی بەردەوام دەدات لە درێژەی تەمەنی ڕۆنەکەدا.',
      ar: 'زيت fully synthetic لمحركات البنزين والديزل. ثبات أعلى في الحرارة وحماية مستمرة طوال عمر الزيت.',
      en: 'A fully synthetic oil for petrol and diesel engines. Greater thermal stability and steady protection across the oil\'s service life.',
    },
    features: {
  ...
  },
  {
    ...
    desc: {
      ku: 'ڕۆنی export quality بۆ بارودۆخی زۆر قورس. چڕی بەرز و volatilityـی نزم وا دەکات خواردنی ڕۆن کەم بێتەوە.',
      ar: 'زيت بجودة التصدير للظروف القاسية جداً. لزوجة عالية وتطاير منخفض يقللان من استهلاك الزيت.',
      en: 'Export-quality oil for severe conditions. High viscosity and low volatility keep oil consumption down.',
    },
    features: {
